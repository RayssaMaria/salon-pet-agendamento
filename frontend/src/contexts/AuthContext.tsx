...
const [user, setUser] = useState(() => {
    const user = localStorage.getItem('user:salon-pet');
    if (user) {
...
async function signIn({ email, password }: ISignIn) {
    ...
    localStorage.setItem('refresh_token:salon-pet', refresh_token);
    localStorage.setItem('user:salon-pet', JSON.stringify(userData));
